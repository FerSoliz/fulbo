          ...
          <Card>
            <CardContent className="p-0 relative">
               <Image
                  ...
                  width={82}
                  height={103}
                  className="absolute left-0 top-0 z-10 cursor-pointer scale-105 transition-transform"
                />
              <Image
          ...
          <Card>
              ...
              {uniqueCode ? (
                ...
                <div className="text-center py-10 border-2 border-dashed rounded-lg">
                  <p className="text-muted-foreground">
                    No hay estadísticas disponibles. Este jugador necesita
                    vincular su código para sincronizar sus datos de juego.
                  </p>
                </div>
              )}
            </CardContent>
            <CardFooter>
              <p className="text-xs text-muted-foreground text-center w-full">
                Las estadísticas se actualizan automáticamente al visitar el
                perfil.
              </p>
            </CardFooter>
          </Card>
