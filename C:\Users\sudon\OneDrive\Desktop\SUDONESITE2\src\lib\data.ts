...
export const defaultVisitor: User = {
    ...
    avatar: 'src/images/MARADONA_Y_EL_PURO_e1630357319461.jpg',
...
export const posts: Post[] = [
    {
        ...
        media: [
            { type: "image", url: "src/images/liga-anual.png" },
        ],
        likes: ['user-2', 'user-3'],
        comments: [
    ...
    },
    {
        ...
        media: [
            { type: "image", url: "src/images/dibu-training-1.jpg" },
            { type: "image", url: "src/images/dibu-training-2.jpg" },
            { type: "image", url: "src/images/dibu-training-3.jpg" },
            { type: "image", url: "src/images/dibu-training-4.jpg" },
            { type: "image", url: "src/images/dibu-training-5.jpg" },
        ],
        likes: ['1'],
        comments: [],
...
export const initialProducts: Product[] = [
  {
    ...
    stock: 15,
    images: [
      'src/images/camiseta-titular-frente.png',
      'src/images/camiseta-titular-espalda.png',
    ],
    isInitial: true,
  },
  {
    ...
    stock: 10,
    images: [
      'src/images/camiseta-suplente-frente.png',
      'src/images/camiseta-suplente-espalda.png',
    ],
    isInitial: true,
  },
   {
